...
public class CameraDialog extends DialogFragment {
	 ...
	 * @return
	 */
	public static CameraDialog showDialog(final Activity parent, String title/* add parameters here if you need */) {
		CameraDialog dialog = newInstance(title/* add parameters here if you need */);
		try {
	...
	public static CameraDialog newInstance(String title/* add parameters here if you need */) {
...
//					mUSBMonitor.openDevice((UsbDevice)item);
...
//		final List<DeviceFilter> filter2 = new ArrayList<>();
